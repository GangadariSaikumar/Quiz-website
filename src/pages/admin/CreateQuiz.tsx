...
import { saveQuiz } from "@/services/localStorageService";
import { useAuth } from "@/contexts/AuthContext";
import { Quiz, Question } from "@/types/quiz.types";
import { createEmptyQuiz, createEmptyQuestion, isQuizComplete } from "@/utils/quizUtils";
...
const CreateQuiz = () => {
  ...
  useEffect(() => {
    if (user) {
      ...
      setQuiz(createEmptyQuiz(user.id));
    }
  }, [user]);
  ...
  return (
    <PageLayout>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-quiz-primary">Create New Quiz</h1>
        <p className="text-gray-500">Fill in the details below to create your quiz</p>
      </div>
